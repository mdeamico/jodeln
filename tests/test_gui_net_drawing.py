...
class MainTest(unittest.TestCase):
    ...
    def test_draw(self):
        ...
        self.window.dialog_open.ui.leLinks.setText(os.path.join(net_folder, "links.txt"))
        self.window.dialog_open.ui.leNodes.setText(os.path.join(net_folder, "nodes.txt"))
